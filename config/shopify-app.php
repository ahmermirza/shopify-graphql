...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Post SEO'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', 'fda671a4e0240330eb9e10b8af1a9061'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '41809f177538e55aa40a29d878293ba4'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_themes,read_products,write_products,read_customers,write_customers,write_orders,write_draft_orders,read_inventory,read_locations,write_inventory'),
    ...
    'webhooks' => [
        ...
        */
        [
            ...
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://post-seo.myshopify.com/webhook/app-uninstalled')
        ],
    ],
